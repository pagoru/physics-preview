...
import { Extract, MSAA_QUALITY, SCALE_MODES } from 'pixi.mjs';
import { Canvas } from 'canvas/canvas';

export const textureUtils = () => {
	const getClonedTexture = (texture: PIXI.Texture): Promise<PIXI.Texture> => {
	...
	const getTextureFromDisplayObject = (
		displayObject: PIXI.DisplayObject,
		region: PIXI.Rectangle = displayObject.getBounds()
	): PIXI.Texture =>
	...
	const getBase64FromDisplayObject = (
		displayObject: PIXI.DisplayObject
	): string =>
